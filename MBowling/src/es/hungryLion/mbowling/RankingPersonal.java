...
public class RankingPersonal extends Activity {		
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		//para poder enviarlo al servicio como parámetro de entrada
		...
		//Utilizamos el servicio de ranking personal, para devolver un listado con las 
		//puntuaciones del socio
